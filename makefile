...
install:
	install -D -m 755 minidlna-makeconfig.py "${DESTDIR}/usr/share/${PKGNAME}/minidlna-makeconfig.sh"
	...
	install -D -m 755 minidlna-autoconfig.py "${DESTDIR}/usr/share/${PKGNAME}/minidlna-autoconfig.sh" 
